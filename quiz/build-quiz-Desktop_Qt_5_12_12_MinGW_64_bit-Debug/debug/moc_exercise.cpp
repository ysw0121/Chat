...
QT_MOC_LITERAL(3, 30, 18) // "on_certain_clicked"
    ...
    "Exercise\0on_return_2_clicked\0\0"
    "on_certain_clicked"
};
...
void Exercise::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<Exercise *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject Exercise::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_Exercise.data,
    qt_meta_data_Exercise,
    qt_static_metacall,
    nullptr,
    nullptr
} };
