...
void game_Register::on_return_2_clicked()
{
    this->close();
...
void game_Register::on_certain_clicked()
{
...
void game_Register::on_name_textEdited(const QString &arg1)
{
    if(ui->name->text()==""){
...
void game_Register::on_password_textEdited(const QString &arg1)
{
    if(ui->password->text()==""){
...
void game_Register::on_showpsw_clicked(bool checked)
{
    if(checked){
